...
df["mean_grey"] = df["sum_grey_C0"]/df["area"]

print(df[["channel_id","center_x","center_y","area","equivalent_radius","mean_grey","annotation_this_channel_type","annotation_other_channel_type"]])      
