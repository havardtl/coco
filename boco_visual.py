...
class MainWindow():
    ...
    def __init__(self,main,categories,current_img):
        '''
        Initialize main window of program with image that shall be annotated

        main        : tk.TK          : tkinter main window to add objects to 
...
current_img = Current_Img(args.session_file,args.from_first,args.height,args.epsilon,args.zoom)

root = tk.Tk()
mainwindow = MainWindow(root,categories,current_img)
