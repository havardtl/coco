...
parser.add_argument('--out_contours',type=str,default = 'stats/3D_contours_stats', help='Output folder for stats about contours')
parser.add_argument('--out_rois',type=str,default = 'stats/3D_rois_stats', help='Output folder for stats about 3d rois')
parser.add_argument('--out_graphical',type=str,default = 'graphical/3D_graphic_segmentation', help='Output folder for graphical representation of segmentation')
