...
parser.add_argument('--out_contours',type=str,default = 'stats_2D/contours_stats', help='Output folder for stats about contours')
parser.add_argument('--out_rois',type=str,default = 'stats_2D/rois_stats', help='Output folder for stats about 3d rois')
parser.add_argument('--out_graphical',type=str,default = 'graphical/graphic_segmentation_2D', help='Output folder for graphical representation of segmentation')
